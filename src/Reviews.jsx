  ...
  return (
    <section id='Reviews' className='py-24'>
      <div className='text-center'>
        <h1 className='text-3xl font-serif mb-10'>⭐Customer Reviews</h1>
      ...
      <div className='w-full flex flex-wrap justify-center gap-5 mt-5'>
       ...
       {reviews.map((rev)=>(
        <div key={rev.id} className=' w-75 h-auto border border-amber-300 rounded-lg p-5 m-5 shadow-lg shadow-gray-400 transition-all hover:scale-105 flex flex-col justify-between'>
            <div className='grow'>
            <p className='text-2xl font-medium'>{rev.message}</p>
            <p className='text-xl mt-3'>{rev.rating}⭐</p> 
          </div> 
