    ...
    <section className='py-25' id='Products'>
      ...
      <div className="w-full flex flex-wrap justify-center gap-12 py-10">
        {facepacks.map((item, id) => (
          ...
          viewport={{ amount: 0.3 }}
            className="w-72 border border-amber-700 rounded-2xl p-4 shadow-lg hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 cursor-pointer bg-white mt-5"
          >
