...
const Feedback = ({setRefresh}) => {
  ...
  return (
   <section id='Feedback' className='my-20'>
   <div className=' justify-center flex'>
    <form onSubmit={handelSubmit}> 
      ...
      <br/>
        <button type="submit"  className='mb-5 p-2 bg-yellow-400 rounded-xl hover:bg-yellow-500 transition-all hover:scale-105 w-50 md:w-100 lg:w-100'>Submit</button>
      </div>
    </form>
