...
const Navbar = () => {
 ...
 const updateCartCount = () => {
  ...
  return (
    <nav>
        ...
        className='fixed top-0 left-0 bg-[#e7cfa8] p-5 flex items-center justify-between md:justify-around lg:justify-around shadow-xl  z-50 w-full ' >
           <div>
            <h1 className='text-md font-semibold font-serif sm:text-xl md:text-2xl lg:text-3xl '> <Link to="/">WildSprout</Link></h1>
            </div> 
 ...
 <li className='text-amber-700 cursor-pointer font-semibold transition-all hover:scale-110 mt-3 flex justify-center items-center gap-1'> <Link to="/login"> <IoMdPerson  /> </Link>Login</li>
            </ul>
            )}
           </div>
